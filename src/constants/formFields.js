...
export const bookingFields = [
  ...
  { name: "status", label: 'Статус', type: "select", options: ["В ожидании", "Подтверждён", "Отменён"], requare: true, error: "Выберите статус" },
...
export const apartFields = [
  ...
  { name: "meal", label: 'Питание', type: "text", error: "Введите Питание" , requare: true},
  { name: "bookingConditions", label: 'Условия бронирования', type: "text", error: "Введите Условия бронирования" , requare: true},
...
export const roomFields = [
  ...
  { name: "roomCount", label: 'Количество комнат', type: "number", error: "Введите количество комнат" , requare: true},
  { name: "level", label: 'Этаж', type: "number", error: "Введите этаж" , requare: true},
  { name: "bedroom", label: 'Спальня', type: "text", error: "Введите Описание Спальни" , requare: true},
  { name: "bathroom", label: 'Санузел', type: "text", error: "Введите Описание Санузла" , requare: true},
  { name: "meal", label: 'Питание', type: "text", error: "Введите Питание" , requare: true},
