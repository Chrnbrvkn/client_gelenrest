          ...
          <div className="calendar__table">
            ...
            <div className="calendar__days">
                ...
                <div className="first__daysList">
                  ...
                  {firstMonthDays.map((day, index) => (
                    <button
                      ...
                      ${
                        checkOutDate &&
                        day === checkOutDate.getDate().toString()
                      } 
                      ...
                      onClick={(e) =>
                        ...
                        !isPastDay(day, 0) &&
                        !isDayBooked(day, 0) &&
                        handleDayClick(day, false, e)
                      }
                      disabled={
                        isPastDay(day, 0) || day === "A" || isDayBooked(day, 0)
                      }
                    >
                      {day !== "A" ? day : ""}
                    </button>
              ...
              <div className="next_month">
                <div className="top">
                  <span>{`${monthsOfYear[(currentMonth + 1) % 12]} ${
                ...
                <div className="first__daysList">
                  ...
                  {secondMonthDays.map((day, index) => (
                    <button
                      ...
                      disabled={
                        isPastDay(day, 1) || day === "A" || isDayBooked(day, 1)
                      }
                    >
                      {day !== "A" ? day : ""}
                    </button>
