...
import '../assets/styles/componentsStyles/reserveModal.css';

export default function BookingModal({ isOpen, closeModal, selectedItem }) {
  return (
      ...
      <Dialog.Panel>
        <div className="modal__bg" onClick={() => closeModal()}>
          <div className="reserve-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <ReserveForm closeModal={closeModal} selectedItem={selectedItem} />
          </div>
        </div>
      </Dialog.Panel>
    </Dialog>
